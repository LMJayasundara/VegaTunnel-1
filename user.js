...
document.addEventListener("DOMContentLoaded", function () {
  ...
  for (let i = 0; i < 15; i++) {
    ...
    col2.className = "col";
    col2.textContent = "shenuka heshan";
...
document
  .getElementById("user-card-close")
  .addEventListener("click", function () {
    ...
    document.getElementById("user-card-text-2").innerHTML =
      "User details will appere here.";
  });
//card remove button - end

//card remove button - strat
document
  .getElementById("user-cardDevice-close")
  .addEventListener("click", function () {
    document.querySelectorAll("li").forEach(function (element) {
      element.classList.remove("bg-info");
    });
...
$("#search-user").on("keyup", function() {
    ...
    console.log(searchvalue);
      ...
      $("#user-list-ul ul").filter(function() {
        $(this).closest("ul").toggle($(this).text().toLowerCase().indexOf(searchvalue) > -1)
      });
  });

// multiple column
// var searchBox_2 = document.getElementById("search-user");
// searchBox_2.addEventListener("keyup",function(){
//   var keyword = this.value;
//   keyword = keyword.toUpperCase();
//   var table_2 = document.getElementById("user-list-ul");
//   var all_tr = table_2.getElementsByTagName("ul");
